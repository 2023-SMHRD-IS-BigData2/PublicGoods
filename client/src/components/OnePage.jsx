        ...
        <div className='fourth-page'>
            <div className='fourth-box'>
                <h3 className='forth-sub'>공지사항</h3>
                    ...
                    <strong>1. 신생기업이라 재무제표 없습니다. 그래도 신용평가가 가능할까요?</strong> <br/>
                    → 저희는 비재무평가만으로도 평가가 가능해서 각종 재무 자료가 없는 경우에도 신용평가등급 산출이 가능합니다.<br/>
                    <br/>
                    <br/>
                    <strong>2. 피드백 서비스란 무엇인가요?</strong><br/>
                    → 대출불가가 나온 원인에 대해서 예상 정보를 제공합니다.
                      그리고 해당 산업의 산업의 <br/>
                      경제 Cycle을 파악하여 해당 기업에 대한 성장가능성 정보를 제공해줍니다.<br/>
                    <br/>
                    <br/>
                    <strong>3. 물론(moolLoan) 서비스가 타사의 기업신용평가 서비스와 비교한 장점은 무엇인가요?</strong><br/>
                    → 은행에게 정보제공 가능하며, 피드백을 제공합니다.<br/>
                    <br/>
                    <br/>
                    <strong>4.  대출 심사는 어떻게 이루어지나요?</strong>  <br/>
                    → 재무와 비재무모델에 따른 머신러닝을 이용한 학습된 모델에 데이터를 넣어 예측된 결과값을 종합하여 대출 가능 불가능 여부에 대해 알려줍니다. <br/>
